...
sRACIPE_RK_adaptive_deterministic <- function( NUM_MODELS=100, PARAMETER_RANGE=100, MPR_MIN=1.,MPR_MAX=100, DNR_MIN=0.1,DNR_MAX=1.,FCH_MIN=1,FCH_MAX=100,HCO_MIN=1L,HCO_MAX=6L,EULER_STEP_SIZE=0.02,EULER_SIM_TIME=50.0,MEDIAN_RANGE=100.0,INITIAL_CONDITIONS=1L,OUTPUT_PRECISION=12L,RK_TOLERANCE = 2^(-5)){
  ...
  Rcpp::sourceCpp("multiGeneCircuit_RK_adaptive_deterministic.cpp")
