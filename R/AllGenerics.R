...
#' done by the simulation. Note that when limit cycles are detected, they are also
#' treated as converged states. This method also adds some statistics to the
#' metadata of the input. Specifically, the final proportion of converged states
