...
#' @param .object RacipeSE object generated by \code{\link{sracipeSimulate}}
#'  function.
#' @param uniqueDigits (optional) Integer. Default NULL. The number of digits past
#' the decimal to count for checking uniqueness. If NULL, the value is taken from
